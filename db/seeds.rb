...
Route.destroy_all
route = Route.create!(name: 'Lady Luck', difficulty: '5.7', pitches: '1, 100ft', description: 'Description goes here.', route_type: 'Sport', user_id: 1)
route2 = Route.create!(name: 'Bad Luck', difficulty: '5.9', pitches: '1, 90ft', description: 'Description goes here.', route_type: 'Sport', user_id: 1)
route3 = Route.create!(name: 'Bad Wolf', difficulty: '5.12a', pitches: '3, 390ft', description: 'Description goes here.', route_type: 'Sport, multipitch', user_id: 1) 
